...
class SuggestedPlacesController extends StateNotifier<AsyncValue<ForecastData>> {
  SuggestedPlacesController(this._weatherRepository, {required String city})
...
final hourlyWeatherControllerProvider = StateNotifierProvider.autoDispose<
    SuggestedPlacesController, AsyncValue<ForecastData>>((ref) {
  final weatherRepository = ref.watch(weatherRepositoryProvider);
  final city = ref.watch(cityProvider);
  return SuggestedPlacesController(weatherRepository, city: city);
});
